...
public class HomeActivity extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.iothome.R.layout.activity_home);
        ...
        // assign buttons
        button_ON = (Button)findViewById(com.iothome.R.id.button_ON);
        button_OFF = (Button)findViewById(com.iothome.R.id.button_OFF);


        // assign text inputs
        editTextIPAddress = (EditText)findViewById(com.iothome.R.id.eg_IP_address);
        editTextPortNumber = (EditText)findViewById(com.iothome.R.id.eg_port_number);
